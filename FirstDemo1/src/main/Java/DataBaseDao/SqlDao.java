...
/*
    ...
    public List<DownloadSolutionsEntity> QuerySQL(String sql) {
        try {
            ...
            List<DownloadSolutionsEntity> list = new ArrayList<DownloadSolutionsEntity>();
            while (rs.next()) {
                DownloadSolutionsEntity rec = new DownloadSolutionsEntity();
    ...
    public DownloadSolutionsEntity readyEdit(String sql) {
        try {
            ...
            Statement pstm = conn.createStatement();
            ResultSet rs = pstm.executeQuery(sql);
            DownloadSolutionsEntity editSolution = new DownloadSolutionsEntity();
            while (rs.next()) {
    ...
    public void Edit(int editId, DownloadSolutionsEntity newSolution) throws Exception {
        Connection conn = DriverManager.getConnection(URL, NAME, PASSWORD);
        PreparedStatement pstmt;
