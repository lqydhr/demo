...
import ServiceImpl.DownloadSolutionListenner;
...
@EntityListeners(DownloadSolutionListenner.class)
public class DownloadSolutionsEntity {
    @Id
    ...
    public DownloadSolutionsEntity() {
